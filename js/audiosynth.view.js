function AudioSynthView() {
	...
	var fnPlayKeyboard = function(e) {
		...
		if(keyboard[e.keyCode]) {
			if(visualKeyboard[keyboard[e.keyCode]]) {
				visualKeyboard[keyboard[e.keyCode]].style.backgroundColor = '#233b78';
	...
	document.getElementById('sli1').addEventListener('click', function() {
__audioSynth.setVolume(this.value/100);
document.getElementById('lsli1').innerHTML = this.value;
	 });

	 	document.getElementById('sli2').addEventListener('click', function() {
	 __audioSynth.setMooll(this.value);
	 document.getElementById('lsli2').innerHTML = this.value/1000;
	 	 });

		  document.getElementById('sli3').addEventListener('click', function() {
		 __audioSynth.setZab1(this.value);
		 document.getElementById('lsli3').innerHTML = this.value/100;
		 	});
			document.getElementById('sli4').addEventListener('click', function() {
		 __audioSynth.setZab2(this.value);
		 document.getElementById('lsli4').innerHTML = this.value/100;
		 	});

			document.getElementById('sli5').addEventListener('click', function() {
		 __audioSynth.setZab3(this.value);
		 document.getElementById('lsli5').innerHTML = this.value/100;
		 	});

			document.getElementById('sli6').addEventListener('click', function() {
		 __audioSynth.setZab4(this.value);
		 document.getElementById('lsli6').innerHTML = this.value/100;
		 	});
