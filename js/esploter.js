/* Learnitor free projects */

var Canvas = document.getElementById('ehsanGraph');  
var Ctx = null ;
var grdivv = document.getElementById('graphdiv');
var esplotbackcolor = document.getElementById('esplotbackcolor');
var esplotchartcolor = document.getElementById('esplotchartcolor');
var esplotaxestcolor = document.getElementById('esplotaxestcolor');
function setGrhaphBcolor()
{
	grdivv.style.background = esplotbackcolor.value;
}
setGrhaphBcolor();
...
var faselY = 1;
var indde = 3 ;
var axesColor = esplotaxestcolor.value;
var textColors = esplotaxestcolor.value;
function setAllGraphColor()
{
	axesColor = esplotaxestcolor.value;
    textColors = esplotaxestcolor.value;
}
var pX1 = 0;
var pY1 = 0;
var pX2 = 0;
...
function RenderFunction(f) {
	...
	Ctx.strokeStyle = esplotchartcolor.value;
	Ctx.stroke() ;
}
